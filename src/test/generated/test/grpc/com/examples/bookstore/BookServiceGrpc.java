...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.examples.bookstore.GetBookRequest,
      com.examples.bookstore.BookResponse> getGetBookMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBook",
      requestType = com.examples.bookstore.GetBookRequest.class,
      responseType = com.examples.bookstore.BookResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.examples.bookstore.GetBookRequest,
      com.examples.bookstore.BookResponse> getGetBookMethod() {
    io.grpc.MethodDescriptor<com.examples.bookstore.GetBookRequest, com.examples.bookstore.BookResponse> getGetBookMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getGetBookMethod = BookServiceGrpc.getGetBookMethod) == null) {
          BookServiceGrpc.getGetBookMethod = getGetBookMethod =
              io.grpc.MethodDescriptor.<com.examples.bookstore.GetBookRequest, com.examples.bookstore.BookResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBook"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.examples.bookstore.GetBookRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.examples.bookstore.BookResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.examples.bookstore.BookAuthorRequest,
      com.examples.bookstore.BookResponse> getGetBooksViaAuthorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBooksViaAuthor",
      requestType = com.examples.bookstore.BookAuthorRequest.class,
      responseType = com.examples.bookstore.BookResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.examples.bookstore.BookAuthorRequest,
      com.examples.bookstore.BookResponse> getGetBooksViaAuthorMethod() {
    io.grpc.MethodDescriptor<com.examples.bookstore.BookAuthorRequest, com.examples.bookstore.BookResponse> getGetBooksViaAuthorMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getGetBooksViaAuthorMethod = BookServiceGrpc.getGetBooksViaAuthorMethod) == null) {
          BookServiceGrpc.getGetBooksViaAuthorMethod = getGetBooksViaAuthorMethod =
              io.grpc.MethodDescriptor.<com.examples.bookstore.BookAuthorRequest, com.examples.bookstore.BookResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBooksViaAuthor"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.examples.bookstore.BookAuthorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.examples.bookstore.BookResponse.getDefaultInstance()))
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBook(com.examples.bookstore.GetBookRequest request,
        io.grpc.stub.StreamObserver<com.examples.bookstore.BookResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetBookMethod(), responseObserver);
    }

    /**
     */
    public void getBooksViaAuthor(com.examples.bookstore.BookAuthorRequest request,
        io.grpc.stub.StreamObserver<com.examples.bookstore.BookResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.examples.bookstore.GetBookRequest,
                com.examples.bookstore.BookResponse>(
                  this, METHODID_GET_BOOK)))
          .addMethod(
            getGetBooksViaAuthorMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.examples.bookstore.BookAuthorRequest,
                com.examples.bookstore.BookResponse>(
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public com.examples.bookstore.BookResponse getBook(com.examples.bookstore.GetBookRequest request) {
    ...
    /**
     */
    public com.examples.bookstore.BookResponse getBooksViaAuthor(com.examples.bookstore.BookAuthorRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.examples.bookstore.BookResponse> getBook(
        com.examples.bookstore.GetBookRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.examples.bookstore.BookResponse> getBooksViaAuthor(
        com.examples.bookstore.BookAuthorRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BOOK:
          serviceImpl.getBook((com.examples.bookstore.GetBookRequest) request,
              (io.grpc.stub.StreamObserver<com.examples.bookstore.BookResponse>) responseObserver);
          break;
        case METHODID_GET_BOOKS_VIA_AUTHOR:
          serviceImpl.getBooksViaAuthor((com.examples.bookstore.BookAuthorRequest) request,
              (io.grpc.stub.StreamObserver<com.examples.bookstore.BookResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BookServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.examples.bookstore.BookstoreProto.getDescriptor();
    }
